...
namespace XNATweener
{
    ...
    public abstract class BaseTweener<T> : ITweener<T>
    {
        ...
        {
            get { return new LoopHelper(this); }
        }
        ...
        public struct LoopHelper
        {
            ...
            private readonly ITweener _tweener;
            ...
            {
                XNATweener.Loop.BackAndForth(_tweener);
            }

            public void BackAndForth(int times)
            {
                XNATweener.Loop.BackAndForth(_tweener, times);
            }

            public void FrontToBack()
            {
                XNATweener.Loop.FrontToBack(_tweener);
            }

            public void FrontToBack(int times)
            {
                XNATweener.Loop.FrontToBack(_tweener, times);
            }
