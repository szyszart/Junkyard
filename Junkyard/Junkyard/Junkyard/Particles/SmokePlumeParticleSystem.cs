...
namespace Junkyard.Particles
{
	...
	{
	    public SmokePlumeParticleSystem(Game game, ParticleManager particleManager, int howManyEffects) : base(game, particleManager, howManyEffects)
	    {
	    }
		...
		protected override void InitializeConstants()
		{
			...
			minRotationSpeed = -Microsoft.Xna.Framework.MathHelper.PiOver4 / 2.0f;
			maxRotationSpeed = Microsoft.Xna.Framework.MathHelper.PiOver4 / 2.0f;
