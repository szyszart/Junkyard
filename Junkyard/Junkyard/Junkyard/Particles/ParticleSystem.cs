...
namespace Junkyard.Particles
{
	...
	public abstract class ParticleSystem : DrawableGameComponent
	{
		...
		public override void Draw(GameTime gameTime)
		{
			...
			// initializeConstants
			particleManager.SpriteBatch.Begin(SpriteSortMode.Deferred, blendState);
			...
			foreach (Particle p in particles)
			{
				...
				particleManager.SpriteBatch.Draw(texture, p.Position, null, color,
					p.Rotation, origin, scale, SpriteEffects.None, 0.0f);
			}

			particleManager.SpriteBatch.End();
