...
{
    class BattleOverScreen : GameScreen
    {
        #region Fields
        ...
        /// usage text prompt.
        /// </summary>
        public BattleOverScreen(string message)
            : this(message, true)
        { }
        ...
        public override void Activate(bool instancePreserved)
        {
            if (!instancePreserved)
            {
                ...
                frameTexture = content.Load<Texture2D>("Images/Menus/puste");
            }
        }
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            spriteBatch.Draw(frameTexture, backgroundRectangle, fColor);
